...
var Closeio = function(apiKey) {
  ...
  this.user = {
    ...
    read: function(id) {
      if (!id) throw new Error('Id is required to read user');
      return closeio._get('/user/' + id + '/');
    },
    list() {
      return closeio._get('/user');
    }
  };
  this.organization = {
    read: function(id) {
  ...
  this.note = {
    create(lead_id, note) {
      return closeio._post('/activity/note/', { lead_id, note });
    },
    read(id) {
      return closeio._get('/activity/note/' + id + '/');
    },
    update(id, options) {
      return closeio._put('/activity/note/' + id + '/', options);
    },
